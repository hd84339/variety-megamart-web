...
import { ShoppingBag, Trash2, Plus, Minus, ArrowLeft, ShoppingCart, CreditCard, ShieldCheck, Banknote, CheckCircle2 } from "lucide-react";
...
const Cart = () => {
  ...
  const updateQuantity = async (item, delta) => {
    ...
    try {
      // 🔥 API IS 'SET QUANTITY' (NOT ADDITIVE)
